...
class LK_Wxpay_Helper_Api extends LK_Wxpay_Helper_Data
{
    ...
    public function makeQROrder($sendData){
        ...
        //获取沙箱密钥sandbox_signkey
        $responseXmlofsignkey = self::curlPost('https://api.mch.weixin.qq.com/sandboxnew/pay/getsignkey', $this->arrayToXml2($unified));
        $sandbox_signkey = simplexml_load_string($responseXmlofsignkey, 'SimpleXMLElement', LIBXML_NOCDATA)->sandbox_signkey;
        ...
        //$responseXml = self::curlPost('https://api.mch.weixin.qq.com/pay/unifiedorder', $this->arrayToXml($unified));  //正式数据调起支付交易
